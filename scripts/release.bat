...
tw3-cahirp build --game "%gamePath%" --recipes "%modpath%/release/mods/modAutomaticDialogPicker/cahirp" --out "%modpath%/release/mods/modAutomaticDialogPicker/content/scripts"
